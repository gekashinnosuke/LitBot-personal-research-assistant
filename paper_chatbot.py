...
if question and "embeddings" in st.session_state:
    ...
    with st.spinner("回答生成中..."):
        ...
        prompt = f"""
以下は複数論文から抽出した関連部分です。
これを参考に質問に答えてください。細かな数字ばかりなならずに、代表例を示すときだけ数字を使う。相手がその分野の素人だと思って。長すぎず、多くても300時くらい。
本質を伝える。最後に、質問された内容に関連のあることを示し、「これについても知りたいですか？」と聞く。これとならべて「もっと詳しく知りたいですか？」と聞く。それにイエスと答えたら、具体的な数字や詳細を用いて説明する。
